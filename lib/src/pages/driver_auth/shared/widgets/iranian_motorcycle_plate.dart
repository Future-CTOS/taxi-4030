...
class IranianMotorcyclePlate extends StatefulWidget {
  final List<String> letters;
  final String? selectedLetter;
  final ValueChanged<String>? onCompleted;

  const IranianMotorcyclePlate({
    super.key,
  ...
  @override
  State<IranianMotorcyclePlate> createState() => _IranianCarPlateState();
}

class _IranianCarPlateState extends State<IranianMotorcyclePlate>
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _plateBox(context, 1, maxLength: 5),
            ],
          ),
        ),
      ),
